 ...
 * @route '//admin.localhost/users/create'
 */
...
create.definition = {
    methods: ["get","head"],
    url: '//admin.localhost/users/create',
} satisfies RouteDefinition<["get","head"]>
...
edit.definition = {
    methods: ["get","head"],
    url: '//admin.localhost/users/{record}/edit',
} satisfies RouteDefinition<["get","head"]>
